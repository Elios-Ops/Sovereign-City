...
| Muskrats.io (`apps/muskrats/index.html:141`) | "ENTER THE SEWER" button | `onclick="window.location.href='poster.html'"` | `apps/muskrats/poster.html` | Muskrats.io internal page — "The Sewer" (titled "WELCOME TO SEWER ALLEY" / "Operation Moon Vault") | **Confirmed end-to-end** — destination now imported and verified to serve (HTTP 200, byte-exact). |
| Muskrats.io (`apps/muskrats/poster.html`, "Gameplay" dropdown) | "The Mission Gate" / "Dossier Lobby" / "Cellar Vault" / "Codex Manifesto" / "The Syndicate Terminal" links | `<a href>` (root-relative paths: `/gate`, `/dossier_lobby`, `/cellar`, `/codex`, `/syndicate`) | Muskrats.io internal pages (not yet imported: `dossier_lobby.html`, `cellar.html`, `codex.html`, `syndicate.html`; `gate.html` already imported) | Muskrats.io internal navigation | Confirmed in source; most destinations not yet imported |
| Muskrats.io (`apps/muskrats/poster.html`, easter egg) | Easter egg image (left egg icon) | `onclick="window.location.href='joboffer.html'"` | `apps/muskrats/joboffer.html` | Muskrats.io internal page | Confirmed in source and destination file present |
