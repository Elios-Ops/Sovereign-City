...
| Infinite Agentic Loop | Infinite Agentic Loop | Infinite Agentic Loop | `AI_APP/infinite-agentic-loop-site/` → `apps/infinite-agentic-loop/` | `index.html` | Not deployed (historically `agentic-loop.netlify.app`) | See `docs/recovery/INFINITE_AGENTIC_LOOP_LOCAL_VERIFICATION.md` — PASS | Imported and verified |
